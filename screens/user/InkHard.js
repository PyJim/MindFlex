...
const InkHard = ({ navigation }) => {
    ...
    useEffect(() => {
        const shuffledQuestions = shuffleQuestions([
            ...
            { "color": "Cyan", "inkColor": "magenta" },
            { "color": "Magenta", "inkColor": "cyan" },
            { "color": "Gold", "inkColor": "silver" },
            { "color": "Silver", "inkColor": "gold" },
            { "color": "Turquoise", "inkColor": "coral" },
        ]);
    ...
    const handleAnswer = (selectedInkColor) => {
        const currentQuestion = questions[questionIndex];

        if (selectedInkColor === currentQuestion.inkColor) {
