import { View, Image, StyleSheet, TouchableOpacity, Text, ImageBackground, Share, Alert } from 'react-native';
            ...
            onPress={() => {
                ...
                [
                    ...
                    onPress: async () => {
                        try {
                        await auth.signOut();
                        // You can perform any additional actions after signing out here.
                        } catch (error) {
